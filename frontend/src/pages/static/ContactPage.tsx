...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <h1 className="text-3xl font-semibold text-neutral-900 mb-2">Contact Us</h1>
      <p className="text-neutral-500 mb-10">We're here to help</p>

      <div className="grid md:grid-cols-2 gap-10">
        <div className="space-y-6">
          {[
            { icon: '📧', label: 'Email', val: 'support@phoenix .id' },
            { icon: '📱', label: 'WhatsApp', val: '+62 812 3456 7890' },
            { icon: '⏰', label: 'Business Hours', val: 'Mon–Fri, 9AM–5PM WIB' },
          ].map((item) => (
